...
input_plot_file_format   = f"{prefix}_"+"plot_{num}_input.jpg"
animation_file_format    = f"{prefix}_"+"animation_{num}.jpg"
intermediate_file_format = f"{prefix}_"+"temp_{num}.jpg"
combined_file_format     = f"{prefix}_"+"{num}.jpg"
video_framerate          = 15
data_file                = f"{prefix}_"+"data.json"

video_file_name = lambda : f"output.mp4"